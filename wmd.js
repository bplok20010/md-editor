...
Attacklab.wmdBase = function(){
	...
	wmd.editor = function(previewRefreshCallback, uuid){
		...
		var setUndoRedoButtonStates = function(){
			if(undoMgr){
				setupButton(document.getElementById("wmd-undo-button-" + uuid), undoMgr.canUndo());
				setupButton(document.getElementById("wmd-redo-button-" + uuid), undoMgr.canRedo());
			}
		};
		...
		var makeSpritedButtonRow = function(){
			...
			var buttonBar = wmd.panels.buttonBar;//document.getElementById("wmd-button-bar");
			...
			boldButton.id = "wmd-bold-button-" + uuid;
			boldButton.title = "加粗 <strong> Ctrl+B";
			boldButton.innerHTML = '<a class="editor__menu--bold" style="background-position: 0px 0px;"></a>';
			...
			italicButton.id = "wmd-italic-button-" + uuid;
			italicButton.title = "斜体 <em> Ctrl+I";
			italicButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -20px 0px;"></a>';
			...
			spacer1.className = "editor__menu--divider wmd-spacer";
			spacer1.id = "wmd-spacer1-" + uuid;
			buttonRow.appendChild(spacer1); 

			var linkButton = document.createElement("li");
			linkButton.className = "wmd-button";
			linkButton.id = "wmd-link-button-" + uuid;
			linkButton.title = "链接 <a> Ctrl+L";
			linkButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -40px 0px;"></a>';
			...
			quoteButton.id = "wmd-quote-button-" + uuid;
			quoteButton.title = "引用 <blockquote> Ctrl+Q";
			quoteButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -60px -0px;"></a>';
			...
			codeButton.id = "wmd-code-button-" + uuid;
			codeButton.title = "代码 <pre><code> Ctrl+K";
			codeButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -80px -0px;"></a>';
			...
			imageButton.id = "wmd-image-button-" + uuid;
			imageButton.title = "图片 <img> Ctrl+G";
			imageButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -100px -0px;"></a>';
			...
			spacer2.className = "editor__menu--divider wmd-spacer";
			spacer2.id = "wmd-spacer2-" + uuid;
			buttonRow.appendChild(spacer2); 

			var olistButton = document.createElement("li");
			olistButton.className = "wmd-button";
			olistButton.id = "wmd-olist-button-" + uuid;
			olistButton.title = "数字列表 <ol> Ctrl+O";
			olistButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -120px -0px;"></a>';
			...
			ulistButton.id = "wmd-ulist-button-" + uuid;
			ulistButton.title = "普通列表 <ul> Ctrl+U";
			ulistButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -140px -0px;"></a>';
			...
			headingButton.id = "wmd-heading-button-" + uuid;
			headingButton.title = "标题 <h1>/<h2> Ctrl+H";
			headingButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -160px -0px;"></a>';
			...
			hrButton.id = "wmd-hr-button-" + uuid;
			hrButton.title = "分割线 <hr> Ctrl+R";
			hrButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -180px -0px;"></a>';
			...
			spacer3.className = "editor__menu--divider wmd-spacer";
			spacer3.id = "wmd-spacer3-" + uuid;
			buttonRow.appendChild(spacer3); 
			
			var undoButton = document.createElement("li");
			undoButton.className = "wmd-button";
			undoButton.id = "wmd-undo-button-" + uuid;
			undoButton.title = "撤销 - Ctrl+Z";
			undoButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -200px -0px;"></a>';
			...
			redoButton.id = "wmd-redo-button-" + uuid;
			...
			redoButton.innerHTML = '<a class="editor__menu--bold" style="background-position: -220px -0px;"></a>';
		...
		var setupEditor = function(){
			...
			util.addEvent(inputBox, keyEvent, function(key){
				...
				if (key.ctrlKey || key.metaKey) {
					...
					switch(keyCodeStr) {
						case "b":
							doClick(document.getElementById("wmd-bold-button-" + uuid));
							break;
						case "i":
							doClick(document.getElementById("wmd-italic-button-" + uuid));
							break;
						case "l":
							doClick(document.getElementById("wmd-link-button-" + uuid));
							break;
						case "q":
							doClick(document.getElementById("wmd-quote-button-" + uuid));
							break;
						case "k":
							doClick(document.getElementById("wmd-code-button-" + uuid));
							break;
						case "g":
							doClick(document.getElementById("wmd-image-button-" + uuid));
							break;
						case "o":
							doClick(document.getElementById("wmd-olist-button-" + uuid));
							break;
						case "u":
							doClick(document.getElementById("wmd-ulist-button-" + uuid));
							break;
						case "h":
							doClick(document.getElementById("wmd-heading-button-" + uuid));
							break;
						case "r":
							doClick(document.getElementById("wmd-hr-button-" + uuid));
							break;
						case "y":
							doClick(document.getElementById("wmd-redo-button-" + uuid));
							break;
						case "z":
							if(key.shiftKey) {
								doClick(document.getElementById("wmd-redo-button-" + uuid));
								...
								doClick(document.getElementById("wmd-undo-button-" + uuid));
							}
							break;
						default:
							return;
	...
	command.doCode = function(chunk, postProcessing, useDefaultText){
		...
		if((!hasTextAfter && !hasTextBefore) || /\n/.test(chunk.selection)){
			...
			if(!chunk.selection){
				chunk.startTag = "    ";
				chunk.selection = useDefaultText ? "请输入代码" : "";
			}
			else {
...
if(!Attacklab.wmd)
{
	...
	Attacklab.Editor = function(elm, opts){
		...
		this.panels = {
			buttonBar : doc.getElementById("wmd-button-bar-" + uuid),
			preview : doc.getElementById("wmd-preview-" + uuid),
			output : doc.getElementById("wmd-output-" + uuid),
	...
	Attacklab.Editor.prototype = {
		getValue: function(){
			return this.panels.output.value;
		},
		getHtml: function(){
			return this.editor.output();	
		},
		setValue: function(str){
			this.panels.output.value = str;	
		}
	}
};
